...
import InsightsWidget from '@/components/InsightsWidget'; // Importez le nouveau composant
...
const ClassDetailPageForTeacher = () => {
  ...
  return (
    <div>
      ...
      {/* --- AJOUTEZ LE NOUVEAU WIDGET ICI, EN HAUT DE LA GRILLE --- */}
      <div className="mb-8">
                <InsightsWidget classId={classId} />
            </div>
