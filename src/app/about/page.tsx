...
//   ArrowDown, HardHat, Ruler, Hammer, Building, ArrowRight, MapPin, Phone, Mail
// } from 'lucide-react';


// // --- IMPORTS SWIPER simple de facons  ---
...
//       {/* ------------------------------------------------------- */}
//       {/* 1. HERO SECTION (SWIPER SLIDER PRO) */}
//       {/* ------------------------------------------------------- */}
//       <section className="relative h-screen w-full">
//         <Swiper
//           modules={[Autoplay, EffectFade, Pagination]}
//           effect={'fade'} // Fondu enchaîné (Pas d'écran noir)
//           fadeEffect={{ crossFade: true }} // Mélange les images
//           speed={1500} // Vitesse de transition lente et élégante
//           loop={true}
//           autoplay={{
//             delay: 5000,
...
//               return '<span class="' + className + ' bg-nexus-orange"></span>';
//             },
//           }}
...
//                           <p className="text-nexus-orange font-bold uppercase tracking-[0.3em] text-sm md:text-base animate-in fade-in slide-in-from-bottom-4 duration-1000">
//                               {slide.subtitle}
//                           </p>
//                       </div>
//                       <h1 className="text-5xl md:text-8xl font-black text-white mb-6 leading-tight animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-150">
//                           {slide.title}
//                       </h1>
//                       <p className="text-gray-200 text-lg md:text-2xl font-light border-l-4 border-nexus-orange pl-6 leading-relaxed max-w-2xl animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300">
//                           {slide.desc}
//                       </p>
//                   </div>
//               </div>
...
//               <div className="absolute top-10 right-10 text-9xl font-black text-white/5 select-none pointer-events-none">
//                   0{index + 1}
//               </div>
//             </SwiperSlide>
//           ))}
...
//       {/* ------------------------------------------------------- */}
//       {/* 2. LES PILIERS (MISSION - VISION - ENGAGEMENT) */}
//       {/* ------------------------------------------------------- */}
...
//                     </p>
//                 </div>
//                 <div className="order-1 md:order-2 h-[300px] md:h-[400px] bg-[url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=1000')] bg-cover bg-center rounded-3xl opacity-90 transition-all duration-700"></div>
//             </div>
//         </section>
...
//                     </ul>
//                 </div>
//                 <div className="order-1 md:order-2 h-[300px] md:h-[400px] bg-[url('https://images.unsplash.com/photo-1503387762-592deb58ef4e?q=80&w=1000')] bg-cover bg-center rounded-3xl opacity-90 transition-all duration-700"></div>
//             </div>
//         </section>
//       </div>
...
//             {[
//                 { name: "Saliou Diop", role: "Directeur Technique", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=800", icon: HardHat },
